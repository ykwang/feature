...
cascade = ( CvHaarClassifierCascade* )cvLoad( "1256617233-1-haarcascade-hand.xml", 0, 0, 0 );
...
CvSeq *hand = cvHaarDetectObjects(img, cascade, hstorage, 1.2, 2, CV_HAAR_DO_CANNY_PRUNING, cvSize(30, 30));
